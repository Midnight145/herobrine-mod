...
public class ClientProxy extends CommonProxy {
    ...
    public void registerRenderers() {
        if (Config.mini_mode) {
            ...
            RenderingRegistry
                .registerEntityRenderingHandler(EntityEvilCow.class, new RenderEvilCow(new ModelCow(), 0.5F));
            RenderingRegistry
                .registerEntityRenderingHandler(EntityEvilPig.class, new RenderEvilPig(new ModelPig(), 0.5F));

            RenderingRegistry.registerEntityRenderingHandler(
                EntityDummySpawner.class,
                new RendererHMod(
                    new ModelBiped(),
                    new ResourceLocation("herobrinemod", "textures/mob/sucker.png"),
                    1.0F));
            RenderingRegistry.registerEntityRenderingHandler(
                EntityFighter.class,
                new RendererHMod(
                    ...
                    1.0F));
            RenderingRegistry.registerEntityRenderingHandler(
                EntityFighterNotch.class,
                new RendererHMod(
                    new ModelBiped(),
                    new ResourceLocation("herobrinemod", "textures/mob/notch.png"),
                    1.0F));
            RenderingRegistry.registerEntityRenderingHandler(
            ...
            RenderingRegistry.registerEntityRenderingHandler(
                ...
                new RendererHMod(
                    ...
                    1.0F));
            RenderingRegistry.registerEntityRenderingHandler(
                EntityEvilZombie.class,
                new RendererHMod(
                    new ModelZombie(),
                    new ResourceLocation("herobrinemod", "textures/mob/zombie.png"),
                    1.0F));
            RenderingRegistry.registerEntityRenderingHandler(
                EntityHerobrineBoss.class,
                new RendererHMod(
                    new ModelBiped(),
                    new ResourceLocation("herobrinemod", "textures/mob/sucker.png"),
                    1.0F));
            ...
            RenderingRegistry
                .registerEntityRenderingHandler(EntityEvilCow.class, new RenderEvilCow(new ModelCow(), 0.25F));
            RenderingRegistry
                .registerEntityRenderingHandler(EntityEvilPig.class, new RenderEvilPig(new ModelPig(), 0.25F));
            RenderingRegistry.registerEntityRenderingHandler(
                EntityHerobrineBoss.class,
                new RendererHMod(
                    new ModelBiped(),

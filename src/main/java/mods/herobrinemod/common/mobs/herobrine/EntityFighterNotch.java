...
public class EntityFighterNotch extends EntityHerobrineBase {
	...
	protected Entity findPlayerToAttack() {
		final int range = 100;
		final List<EntityFighter> list_ = this.worldObj.getEntitiesWithinAABB(EntityFighter.class,
		...
		if (!list_.isEmpty()) { return list_.get(this.worldObj.rand.nextInt(list_.size())); }
		this.wait++;

	...
	public void onLivingUpdate() {
        ...
        switch (val) {
            ...
            case 2:
                ...
                break;
            case 3:
                this.worldObj.spawnEntityInWorld(new EntityEvilChicken(this.worldObj, (float) this.posX + 0.5F,
                    (float) this.posY + 0.0F, (float) this.posZ + 0.5F));
            case 4:
                this.worldObj.spawnEntityInWorld(new EntityEvilPig(this.worldObj, (float) this.posX + 0.5F,
                    (float) this.posY + 0.0F, (float) this.posZ + 0.5F));
                break;
            case 5:
                this.worldObj.spawnEntityInWorld(new EntityEvilCow(this.worldObj, (float) this.posX + 0.5F,
                    (float) this.posY + 0.0F, (float) this.posZ + 0.5F));
                break;
            default:
                didSomething = false;

...
{
    private static final ResourceLocation texture = new ResourceLocation("herobrinemod","textures/mob/angrychicken.png");
        ...
        protected ResourceLocation getChickenTextures(EntityChicken2 par1EntityChicken)
        {
            return texture;
        }
        ...
        {
            return this.getWingRotation((EntityChicken2)par1EntityLivingBase, par2);
        }

        public void renderPlayer(EntityLivingBase par1EntityLivingBase, double par2, double par4, double par6, float par8, float par9)
        {
            this.renderChicken((EntityChicken2)par1EntityLivingBase, par2, par4, par6, par8, par9);
        }
        ...
        {
            return this.getChickenTextures((EntityChicken2)par1Entity);
        }

...
public class EntityJetra extends EntityAnimal{
	 ...
	 public EntityJetra(World world, double x, double y, double z)
	    ...
	    public void onLivingUpdate()
	    {
	    	...
	    	if(speak_timer <speak_down)
	    	{
	            ...
	            if(!worldObj.isRemote && entityplayer2 != null)
	            	   MinecraftServer.getServer().getConfigurationManager().sendChatMsg(new ChatComponentText("Jetra says: " + phrases[msg]));
		...
		public EntityAgeable createChild(EntityAgeable entityageable) {
		 ...
		 public static String[] phrases = {"I feel lonely", "PLEASE!! DON'T HIT ME!", "Why am I here?", "Lol I'm in the herobrine mod.", "It hurts.", "I'm useless.", "My mum doesn't love me anymore :(", "I'm smelly -.-", 
			 "DafUQ BRO?", "Whuut?", "Blablablablabla", "I have no friends.", "My parents don't love me.", "Hi I'm 12.", "Muuuuh!", "Wanna be my friend?", "I'm sad :(", "I'm an emo.", "I have no gf.", 
			 "Everybody hates me :("};
